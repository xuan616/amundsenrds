...
Revision ID: cebb2e0d8d66
Revises: 
Create Date: 2021-04-13 14:03:06.843580
...
def upgrade():
    ...
    op.create_table('dashboard_cluster',
    sa.Column('rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    sa.Column('name', sa.String(length=256), nullable=False),
    sa.Column('published_tag', sa.String(length=128), nullable=False),
    sa.Column('publisher_last_updated_epoch_ms', sa.BigInteger(), nullable=False),
    ...
    op.create_table('updated_timestamp',
    ...
    op.create_table('cluster_metadata',
    sa.Column('rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    sa.Column('name', sa.String(length=256), nullable=False),
    ...
    op.create_table('dashboard_group',
    sa.Column('rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    sa.Column('name', sa.String(length=256), nullable=False),
    ...
    op.create_table('dashboard_group_description',
    sa.Column('rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    ...
    op.create_table('dashboard_badge',
    ...
    op.create_table('dashboard_description',
    sa.Column('rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('dashboard_rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    sa.Column('published_tag', sa.String(length=128), nullable=True),
    ...
    op.create_table('dashboard_execution',
    sa.Column('rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    ...
    op.create_table('dashboard_follower',
    sa.Column('dashboard_rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    ...
    op.create_table('dashboard_query',
    sa.Column('rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    ...
    op.create_table('dashboard_timestamp',
    sa.Column('rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    sa.Column('timestamp', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=256), nullable=False),
    sa.Column('dashboard_rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    ...
    op.create_table('dashboard_usage',
    sa.Column('dashboard_rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    sa.Column('user_rk', sa.String(length=320, collation='latin1_general_cs'), nullable=False),
    ...
    op.create_table('schema_description',
    sa.Column('rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    ...
    op.create_table('schema_programmatic_description',
    sa.Column('rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    sa.Column('description_source', sa.String(length=32), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('schema_rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    ...
    op.create_table('dashboard_table',
    sa.Column('dashboard_rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    sa.Column('table_rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    sa.Column('published_tag', sa.String(length=128), nullable=False),
    sa.Column('publisher_last_updated_epoch_ms', sa.BigInteger(), nullable=False),
    ...
    op.create_table('table_follower',
    sa.Column('table_rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    ...
    op.create_table('table_programmatic_description',
    sa.Column('rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    sa.Column('description_source', sa.String(length=32), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('table_rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    ...
    op.create_table('table_timestamp',
    sa.Column('rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    ...
    op.create_table('table_watermark',
    sa.Column('rk', sa.String(length=1024, collation='latin1_general_cs'), nullable=False),
    ...
    op.create_table('column_description',
    sa.Column('rk', sa.String(length=1536, collation='latin1_general_cs'), nullable=False),
    sa.Column('description_source', sa.String(length=32), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
